                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex items-center gap-2 w-full">
                      <input
                        ...
                        onChange={(e) => setForm({ ...form, daily_rate: e.target.value === '' ? null : e.target.value as unknown as number })}
                        className={`${inputClass} flex-1 w-full min-w-0`}
                      />
                      <div className="relative w-24 shrink-0">
                        <select
                          value={form.currency || 'MAD'}
                          onChange={(e) => setForm({ ...form, currency: e.target.value as 'MAD' | 'EUR' | 'USD' })}
