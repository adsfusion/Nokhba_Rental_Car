...
const sectionClass = 'rounded-2xl border border-slate-100 bg-slate-50/50 p-5 grid grid-cols-1 md:grid-cols-12 gap-4';
  ...
  return (
    <div className="max-w-[1200px] w-full mx-auto space-y-6">
      ...
      <div className="bg-white border border-slate-200 rounded-3xl shadow-sm overflow-hidden">
        ...
        <form dir="ltr" onSubmit={handleSubmit} className="p-6 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-2xl border border-slate-100 bg-slate-50/50 p-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
              {/* Color */}
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-2xl border border-slate-100 bg-slate-50/50 p-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
              ...
              {/* Daily Rate & Currency */}
              <div className="space-y-1.5">
                <label className={`${labelClass} truncate whitespace-nowrap`}>Daily Rate</label>
                <div className="flex items-center gap-2 w-full">
                  <input
                    ...
                    onChange={(e) => setForm((p) => ({ ...p, daily_rate: e.target.value === '' ? null : e.target.value as unknown as number }))}
                    className={`${inputClass} flex-1 w-full min-w-0`}
                  />
                  <div className="relative w-24 shrink-0">
                    <select
                      value={form.currency || 'MAD'}
                      onChange={(e) => setForm((p) => ({ ...p, currency: e.target.value as 'MAD' | 'EUR' | 'USD' }))}
