...
export default function EditReservationForm({
  ...
  useEffect(() => {
    ...
    const origStartLocal = reservation.start_date ? toLocalDateString(new Date(reservation.start_date)) : '';
    const origEndLocal = reservation.end_date ? toLocalDateString(new Date(reservation.end_date)) : '';
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center justify-end gap-3">
          <Link
            ...
            className="px-5 py-2.5 border border-slate-200 text-slate-700 hover:bg-slate-50 transition-colors rounded-xl text-sm font-semibold text-center"
          >
            Cancel
          </Link>
          <button
