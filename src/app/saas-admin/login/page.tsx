...
import { saasAdminLogin } from '@/lib/actions/auth';

export default async function SaasAdminLoginPage({
  searchParams,
}: {
      ...
      <div className="w-full max-w-[448px]">
        <div className="bg-white rounded-2xl shadow-xl shadow-slate-900/10 border border-slate-200 p-8">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-sm text-slate-500 mt-1">Super Admin Access</p>
          </div>

          <form action={saasAdminLogin} className="flex flex-col gap-4">
